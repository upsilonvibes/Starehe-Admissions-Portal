  ...
  return (
    <section id="center" className="landing-selection-card animate-in">
      ...
      <div className="logo-fan-container">
        <img src="/images_starehe/sgc_logo.png" alt="Starehe Girls' Centre Logo" className="logo-card sgc-card" />
        <img src="/images_starehe/sbc_logo.png" alt="Starehe Boys' Centre Logo" className="logo-card sbc-card" />
      </div>
